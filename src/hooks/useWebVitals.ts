...
export function useWebVitals(
  ...
  useEffect(() => {
    ...
    try {
      ...
      // LCP not supported
      logger.debug('LCP metric not supported in this browser', { error: error instanceof Error ? error : undefined });
    }
    ...
    try {
      ...
      // FID not supported
      logger.debug('FID metric not supported in this browser', { error: error instanceof Error ? error : undefined });
    }
    ...
    try {
      ...
      // CLS not supported
      logger.debug('CLS metric not supported in this browser', { error: error instanceof Error ? error : undefined });
    }
    ...
    try {
      ...
      // FCP not supported
      logger.debug('FCP metric not supported in this browser', { error: error instanceof Error ? error : undefined });
    }
    ...
    try {
      ...
      // INP not supported
      logger.debug('INP metric not supported in this browser', { error: error instanceof Error ? error : undefined });
    }
